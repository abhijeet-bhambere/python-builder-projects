...
st.divider()
#rev3 - Getting user input (new task) with 30-tasks limit 
task_limit=5
# Stop accepting user input as soon as limit is reached
if len(todos)>=task_limit:
    st.warning(f"Task limit reached! Complete some tasks to add more.")
else:    
